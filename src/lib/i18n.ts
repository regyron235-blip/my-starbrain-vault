...
export const T = {
  ...
  details:      { ua: "Деталі",         en: "Details",     ru: "Подробнее" },
  income:       { ua: "Дохід",          en: "Income",      ru: "Доход" },
  price:        { ua: "Ціна",           en: "Price",       ru: "Цена" },
  rarity:       { ua: "Рідкість",       en: "Rarity",      ru: "Редкость" },
  close:        { ua: "Закрити",        en: "Close",       ru: "Закрыть" },
