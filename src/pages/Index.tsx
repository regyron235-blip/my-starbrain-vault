...
const BRAINROTS: Brainrot[] = [
  { name: "Griffin",                        rarity: "secret", image: `${import.meta.env.BASE_URL}griffin.svg`,                        income: 400_000_000, priceTag: "1.5B" },
  { name: "Hydra Dragon Cannelloni",        rarity: "secret", image: `${import.meta.env.BASE_URL}hydra-dragon-cannelloni.svg`,        income: 350_000_000, priceTag: "1.3B" },
  ...
  { name: "Headless Horseman",              rarity: "secret", image: `${import.meta.env.BASE_URL}headless-horseman.svg`,              income: 175_000_000, priceTag: "900M" },
  { name: "Rosey and Teddy",                rarity: "secret", image: `${import.meta.env.BASE_URL}rosey-and-teddy.svg`,                income: 165_000_000, priceTag: "800M" },
  { name: "Capitano Moby",                  rarity: "secret", image: `${import.meta.env.BASE_URL}capitano-moby.svg`,                  income: 160_000_000, priceTag: "750M" },
  { name: "Cooki and Milki",                rarity: "secret", image: `${import.meta.env.BASE_URL}cooki-and-milki.svg`,                income: 155_000_000, priceTag: "700M" },
  ...
  { name: "Spooky and Pumpky",              rarity: "secret", image: `${import.meta.env.BASE_URL}spooky-and-pumpky.svg`,              income: 80_000_000,  priceTag: "400M" },
  { name: "Los Spaghettis",                 rarity: "secret", image: `${import.meta.env.BASE_URL}los-spaghettis.svg`,                 income: 70_000_000,  priceTag: "350M" },
  { name: "Spaghetti Tualetti",             rarity: "secret", image: `${import.meta.env.BASE_URL}spaghetti-tualetti.svg`,             income: 60_000_000,  priceTag: "300M" },
  { name: "Garama and Madundung",           rarity: "secret", image: garamaMadundung,                                                 income: 50_000_000,  priceTag: "250M" },
  { name: "W or L",                         rarity: "secret", image: `${import.meta.env.BASE_URL}w-or-l.svg`,                         income: 30_000_000,  priceTag: "200M" },
  { name: "Tralaledon",                     rarity: "secret", image: `${import.meta.env.BASE_URL}tralaledon.svg`,                     income: 27_500_000,  priceTag: "180M" },
  { name: "Los Candies",                    rarity: "secret", image: `${import.meta.env.BASE_URL}los-candies.svg`,                    income: 23_000_000,  priceTag: "150M" },
